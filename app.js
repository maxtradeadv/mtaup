...
try{const s=localStorage.getItem(PROVIDER_KEY);if(['auto','yahoo','remote-csv'].includes(s))$('provider').value=s}catch{}if('serviceWorker'in navigator)navigator.serviceWorker.register('sw.js').catch(()=>{});