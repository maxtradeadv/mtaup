...
type Provider='auto'|'yahoo'|'remote-csv'|'stockbit'|'idx';
...
const providerOf=(v:string|null):Provider=>['yahoo','remote-csv','auto','stockbit','idx'].includes(v||'')?v as Provider:(['yahoo','remote-csv','stockbit','idx'].includes(envGet('DATA_PROVIDER')||'')?envGet('DATA_PROVIDER') as Provider:'auto');
